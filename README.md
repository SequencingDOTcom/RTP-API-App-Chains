...
* App chains allows your app to provide genetically tailored user experience. Your app can now understand and treat each app user as the unique individual they are.
